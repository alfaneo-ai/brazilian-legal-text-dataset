...
class StjPesquisaProntaScraper:
    def __init__(self):
        self.work_progress = WorkProgress()
        self.dataset_manager = DatasetManager()
        self.index_url = 'https://scon.stj.jus.br/SCON/pesquisa_pronta/tabs.jsp'
        self.rootpath = PathUtil.build_path('output', 'sts')

    def execute(self):
        self.work_progress.show('Starting scraper stj for getting pesquisa pronta')
        targetpath = self._create_folder(self.rootpath, 'pesquisa_pronta_stj')
...
class IndexPage:
    ...
    def get_links(self):
        xpath_container = "//div[@class='divTabela']"
